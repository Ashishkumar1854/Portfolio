      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <Link
              to="/"
              className="text-2xl font-display font-bold text-text-primary tracking-tight mb-4 inline-block"
            >
              Ashish<span className="text-accent-blue">.</span>
            </Link>
            <p className="text-text-secondary max-w-sm mb-6">
              Building premium, scalable, and dynamic web experiences. Bridging
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.linkedin.com/in/ashishkumar1854/"
                target="_blank"
                rel="noreferrer"
                className="text-text-muted hover:text-accent-blue transition-colors"
              >
              ...
              <a
                href="https://x.com/ASHISHKUMAR1854"
                target="_blank"
                rel="noreferrer"
                className="text-text-muted hover:text-accent-blue transition-colors"
              >
              ...
              <a
                href="https://www.instagram.com/selffollowerc"
                target="_blank"
                rel="noreferrer"
                className="text-text-muted hover:text-accent-blue transition-colors"
              >
              ...
              <a
                href="mailto:ashishkyadav.dev@gmail.com"
                className="text-text-muted hover:text-accent-blue transition-colors"
              >
                <Mail size={20} />
              </a>
          ...
          <div>
            ...
            <p className="text-sm text-text-secondary mb-4">
              Open for opportunities and collaborations. Let's build something
              amazing together.
            </p>
            <div className="flex flex-wrap gap-3">
              <Link
                to="/hire"
                className="inline-block px-4 py-2 bg-accent-blue/10 text-accent-blue border border-accent-blue/20 rounded-md hover:bg-accent-blue hover:text-white transition-all text-sm font-medium"
              >
                Hire Me
              </Link>
              <a
